...
namespace eudaq {
  ...
  class CMSPixelTRPConverterPlugin : public StdEventConverter {
  public:
  ...
  namespace {
    ...
    Register<CMSPixelTRPConverterPlugin>(CMSPixelTRPConverterPlugin::m_id_factory);
  }


  bool CMSPixelTRPConverterPlugin::Converting(eudaq::EventSPC in, eudaq::StandardEventSP out, eudaq::ConfigurationSPC conf) const {
