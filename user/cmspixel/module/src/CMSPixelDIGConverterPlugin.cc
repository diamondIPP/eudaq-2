...
namespace eudaq {
  ...
  class CMSPixelDIGConverterPlugin : public StdEventConverter {
  public:
    static const uint32_t m_id_factory = eudaq::cstr2hash("CMSPixelDIG");
  ...
  namespace {
    ...
    Register<CMSPixelDIGConverterPlugin>(CMSPixelDIGConverterPlugin::m_id_factory);
  }


  bool CMSPixelDIGConverterPlugin::Converting(eudaq::EventSPC in, eudaq::StandardEventSP out, eudaq::ConfigurationSPC conf) const {
